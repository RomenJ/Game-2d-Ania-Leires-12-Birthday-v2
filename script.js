...
function checkForCollisions() {
    ...
    for (let i = 0; i < blocks.length; i++) {
        ...
        if (ballCurrentPosition[0] > blocks[i].bottomLeft[0] && ballCurrentPosition[0] < blocks[i].bottomRight[0] &&
            ...
            if (blocks.length === 0) {
                ...
                scoreDisplay.innerHTML = "FELICIDADES SOBRINA, QUE SEAS MUY MUY FELIZ EN ESTE DÍA";
    ...
    if (ballCurrentPosition[1] <= 0) {
        clearInterval(timerID);
        scoreDisplay.innerHTML = " No se trata de si van a derribarte, se trata de si vas a lecantarte cuando lo hagan";
        document.removeEventListener('keydown', moveUser);
    }
